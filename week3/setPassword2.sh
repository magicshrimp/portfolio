...
#this is where the password is converted to a hash and saved at the desired location as a txt doc
echo $password | sha256sum > ~/scripts/portfolio/"$week"/password.txt
